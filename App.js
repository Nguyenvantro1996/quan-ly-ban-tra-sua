...
viewFood(data) {
  ...
  return (
       ...
       <View style = {{flexDirection: 'row', borderBottomWidth:1, alignItems: 'center', padding: 5, backgroundColor: 'peru'}}>
                {this.viewTextInput()}
                  ...
                  return (
                    ...
                    <TouchableOpacity 
                      ...
                      <View style = {{backgroundColor:parseInt(index) % 2 == 0  ? 'orange1': 'pink1', flexDirection: 'column',alignItems: 'center', width: 340, padding: 5,  }}> 
                        ...
                        <Text style = {{borderBottomWidth:1, width: 340, textAlign: 'center', backgroundColor: 'orange', fontSize: 18}}> {item.name} </Text>
                        <Text style = {{borderBottomWidth:1, width: 340, textAlign: 'center', backgroundColor: 'orange', fontSize: 18, }}>  {item.money} vnd </Text>
                      </View>
    ...
    var navigationView = (
        <View style={{flex: 1, backgroundColor: 'white',alignContent:'center', justifyContent: 'center'}}>
          <TouchableOpacity onPress = {() => {}}> 
            <Text style={{margin: 10, fontSize: 15, textAlign: 'left', borderBottomWidth: 1}}> Đăng Nhập </Text>
          </TouchableOpacity>
